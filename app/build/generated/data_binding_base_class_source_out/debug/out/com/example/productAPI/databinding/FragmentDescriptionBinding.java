...
public final class FragmentDescriptionBinding implements ViewBinding {
  ...
  private FragmentDescriptionBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton btnBack, @NonNull RecyclerView rvDescription) {
  ...
  public static FragmentDescriptionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rv_description;
      RecyclerView rvDescription = ViewBindings.findChildViewById(rootView, id);
      if (rvDescription == null) {
        break missingId;
      }

      return new FragmentDescriptionBinding((ConstraintLayout) rootView, btnBack, rvDescription);
    }
