...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull TextView abilityCard,
      ...
      @NonNull TextView iconDollars, @NonNull ImageView imageCard, @NonNull TextView modelId,
      @NonNull TextView nameProductCard, @NonNull TextView priceCard,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((LinearLayout) rootView, abilityCard, btnZoom, descriptionCard,
          iconDollars, imageCard, modelId, nameProductCard, priceCard, tovarFavoriteCheck);
    }
